...
export const CHANGELOG = [
    {
        ...
        date: "2024-07-08",
        changes: [
            "Logic Quay Số Thông Minh: Tránh gọi trùng lặp (Cooldown 5 lượt), ưu tiên người ít điểm.",
            "Phân loại Học sinh: Thêm Học lực (Tốt/Khá/Đạt/Chưa đạt).",
            "Phân loại Câu hỏi: Thêm Độ khó (Dễ/TB/Khó).",
            "Logic Điều Kiện: Câu hỏi Khó gọi HS Giỏi, Câu hỏi Dễ gọi HS Yếu.",
            "Cửa hàng Đa cấp: Avatar chia thành 3 mức giá khác nhau (Cấu hình trong Cài đặt)."
        ]
    },
    {
        version: "2.2",
        date: "2024-07-05",
        changes: [
            "Hiệu ứng đặc biệt (Hào quang) cho 'Vị Vua Tri Thức' khi được gọi tên.",
            "Thêm thanh Thống kê Học vị (Tiến sĩ, Thạc sĩ...) trong bảng điều khiển.",
            "Hiển thị phiên bản ngay trên thanh tiêu đề.",
            "Sửa lỗi hiển thị nút Kết thúc phiên.",
            "Dữ liệu Shop (Avatar đã mua) tự động đồng bộ khi Upload lên Cloud."
        ]
    },
    {
        version: "2.1",
...
export const getSettings = (): Settings => {
  if (typeof window === 'undefined') {
      return { 
        ...
        priceTiers: { tier1: 10, tier2: 50, tier3: 100 },
        avatarTiers: {}
      };
  }
  ...
  return { 
      ...
      priceTiers: { ...defaultSettings.priceTiers, ...saved.priceTiers },
      avatarTiers: { ...defaultSettings.avatarTiers, ...saved.avatarTiers }
  };
};
