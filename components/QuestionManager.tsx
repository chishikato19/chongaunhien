...
import { Plus, Trash2, HelpCircle, FileText, CheckSquare, AlertCircle, Copy, Save, RefreshCcw } from 'lucide-react';
                ...
                <div className="flex flex-col h-full overflow-hidden">
                    ...
                    <div className="bg-gray-50 p-4 rounded-xl border border-gray-200 mb-4 space-y-3">
                         ...
                         <div className="flex justify-end">
                            <button onClick={addQuestion} className="bg-pink-600 text-white px-6 py-2 rounded-lg hover:bg-pink-700 font-bold flex items-center gap-2 shadow-sm">
                    ...
                    <div className="flex-grow overflow-y-auto space-y-3 pr-2 custom-scrollbar">
                        {questions.length === 0 ? (
                            ...
                            questions.map((q, idx) => (
                                <div key={q.id} className={`border rounded-lg p-4 transition-colors ${q.isAnswered ? 'bg-gray-100 border-gray-200 opacity-60' : 'bg-white border-gray-200 hover:border-pink-300 shadow-sm'}`}>
                                    <div className="flex justify-between items-start">
                                        ...
                                        <button onClick={() => deleteQuestion(q.id)} className="text-gray-400 hover:text-red-500 p-2">
                                            <Trash2 size={16} />
                                        </button>
                                    </div>
                                </div>
